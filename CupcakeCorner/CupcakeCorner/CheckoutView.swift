...
struct CheckoutView: View {
    ...
    func placeOrder() async {
        ...
        do {
            ...
            confirmationMassage = "Your order \(decodedOrder.quantity)x \(SharedOrder.types[decodedOrder.type].lowercased()) cupcakes is on its way!"
            showingConfirmation = true
        } catch {
            errorMassage = "Sorry, checkout failed.\n\nMessage: \(error.localizedDescription)"
            showingError = true
        }
    }
}
